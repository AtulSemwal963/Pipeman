...
const AboutSection = () => {
  return (
    <section className="py-20 bg-white dark:bg-pipeman-deep-blue">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center text-pipeman-deep-blue dark:text-white mb-12">About PipeMan</h1>
        
        <div className="max-w-3xl mx-auto">
          <div className="mb-12">
            <h2 className="text-2xl font-semibold text-pipeman-deep-blue dark:text-white mb-4">Our Mission</h2>
            <p className="text-pipeman-grey dark:text-gray-300 text-lg leading-relaxed">
          ...
          <div className="flex justify-center mb-12">
            <div className="bg-pipeman-light-blue-grey dark:bg-pipeman-deep-blue/50 rounded-xl p-6 flex items-center space-x-6 max-w-md">
              <Database className="text-pipeman-deep-blue dark:text-white w-14 h-14" />
              <ArrowRightLeft className="text-pipeman-teal w-10 h-10" />
              <FileText className="text-pipeman-deep-blue dark:text-white w-14 h-14" />
            </div>
          </div>
          
          <div className="mb-12">
            <h2 className="text-2xl font-semibold text-pipeman-deep-blue dark:text-white mb-4">How It Works</h2>
            <p className="text-pipeman-grey dark:text-gray-300 text-lg leading-relaxed mb-6">
            ...
            <ul className="list-disc pl-8 text-pipeman-grey dark:text-gray-300 text-lg leading-relaxed mb-6 space-y-2">
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-semibold text-pipeman-deep-blue dark:text-white mb-4">The Team</h2>
            <p className="text-pipeman-grey dark:text-gray-300 text-lg leading-relaxed">
